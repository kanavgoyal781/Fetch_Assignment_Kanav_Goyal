...
def load_model():
    try:
        model = joblib.load("/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/model_updated.pkl")
        return model
...
def main():
    ...
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/Daily Receipt Counts with 365-Day Moving Average.png', use_column_width=True) 
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/Daily Receipt Counts with 180-Day Moving Average.png',  use_column_width=True) 
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/seasonal_plot2.png',  use_column_width=True)
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/seasonal_plot3.png',  use_column_width=True)
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/lagplot.png', use_column_width=True)    
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/PA.png',  use_column_width=True)    
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/Actual vs Predicted Receipt Counts with Forecast.png', use_column_width=True)
    st.image('/Users/kanav/Desktop/MS UChicago/Internship Info/Fetch/Actual vs Forecast Receipt Counts.png',  use_column_width=True)
